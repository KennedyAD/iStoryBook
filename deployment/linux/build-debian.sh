#!/bin/sh
echo Création de la préparation pour la version 4.10.2
echo Paramètres:
echo "- sb.version : " 4.10.2
...
sed -i -e "s/@version@/4.10.2/g" /home/favdb/ext/SB4.10.1/code/distrib/debian-package/DEBIAN/control
sed -i -e "s/@version@/4.10.2/g" /home/favdb/ext/SB4.10.1/code/distrib/debian-package/usr/share/applications/ostorybook.desktop
sed -i -e "s/@version@/4.10.2/g" /home/favdb/ext/SB4.10.1/code/distrib/debian-package/usr/share/doc/ostorybook/changelog
...
dpkg-deb --build /home/favdb/ext/SB4.10.1/code/distrib/debian-package /home/favdb/ext/SB4.10.1/code/distrib/oStorybook-4.10.2.deb
echo Nettoyage...
...
alien -r /home/favdb/ext/SB4.10.1/code/distrib/oStorybook-4.10.2.deb