 ...
 */
public class MVCursor<K, V> implements Iterator<K> {
    ...
    private MVPage lastPage;
    private final MVPage root;
    private boolean initialized;

    MVCursor(MVMap<K, ?> map, MVPage root, K from) {
        this.map = map;
        this.root = root;
        this.from = from;
    }
     ...
     */
    private void min(MVPage p, K from) {
        while (true) {
            if (p.isLeaf()) {
