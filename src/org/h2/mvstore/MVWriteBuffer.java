...
public class MVWriteBuffer {
     ...
     * @return this
     */
    public MVWriteBuffer putVarInt(int x) {
     ...
     * @return this
     */
    public MVWriteBuffer putVarLong(long x) {
     ...
     * @return this
     */
    public MVWriteBuffer putStringData(String s, int len) {
     ...
     * @return this
     */
    public MVWriteBuffer put(byte x) {
     ...
     * @return this
     */
    public MVWriteBuffer putChar(char x) {
     ...
     * @return this
     */
    public MVWriteBuffer putShort(short x) {
     ...
     * @return this
     */
    public MVWriteBuffer putInt(int x) {
     ...
     * @return this
     */
    public MVWriteBuffer putLong(long x) {
     ...
     * @return this
     */
    public MVWriteBuffer putFloat(float x) {
     ...
     * @return this
     */
    public MVWriteBuffer putDouble(double x) {
     ...
     * @return this
     */
    public MVWriteBuffer put(byte[] bytes) {
     ...
     * @return this
     */
    public MVWriteBuffer put(byte[] bytes, int offset, int length) {
     ...
     * @return this
     */
    public MVWriteBuffer put(ByteBuffer src) {
     ...
     * @return this
     */
    public MVWriteBuffer limit(int newLimit) {
     ...
     */
    public MVWriteBuffer position(int newPosition) {
     ...
     * @return this
     */
    public MVWriteBuffer get(byte[] dst) {
        buff.get(dst);
        return this;
    }
     ...
     * @return this
     */
    public MVWriteBuffer putInt(int index, int value) {
     ...
     * @return this
     */
    public MVWriteBuffer putShort(int index, short value) {
