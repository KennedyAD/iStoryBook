...
import org.h2.mvstore.MVWriteBuffer;
 ...
 */
public class MVObjectDataType implements MVDataType {
    ...
    @Override
    public void write(MVWriteBuffer buff, Object[] obj, int len, boolean key) {
        for (int i = 0; i < len; i++) {
            write(buff, obj[i]);
        }
    }
    ...
    @Override
    public void write(MVWriteBuffer buff, Object obj) {
        last.write(buff, obj);
    }
     ...
     */
    abstract static class AutoDetectDataType implements MVDataType {

        protected final MVObjectDataType base;
        protected final int typeId;

        AutoDetectDataType(MVObjectDataType base, int typeId) {
            this.base = base;
            this.typeId = typeId;
        }
        ...
        @Override
        public void write(MVWriteBuffer buff, Object o) {
    ...
    static class NullType extends AutoDetectDataType {
        ...
        NullType(MVObjectDataType base) {
    ...
    static class BooleanType extends AutoDetectDataType {
        ...
        BooleanType(MVObjectDataType base) {
    ...
    static class ByteType extends AutoDetectDataType {
        ...
        ByteType(MVObjectDataType base) {
    ...
    static class CharacterType extends AutoDetectDataType {
        ...
        CharacterType(MVObjectDataType base) {
    ...
    static class ShortType extends AutoDetectDataType {
        ...
        ShortType(MVObjectDataType base) {
    ...
    static class IntegerType extends AutoDetectDataType {
        ...
        IntegerType(MVObjectDataType base) {
            super(base, TYPE_INT);
        }
    ...
    static class LongType extends AutoDetectDataType {
        ...
        LongType(MVObjectDataType base) {
    ...
    static class FloatType extends AutoDetectDataType {
        ...
        FloatType(MVObjectDataType base) {
        ...
        public void write(MVWriteBuffer buff, Object obj) {
            ...
            if (f == MVObjectDataType.FLOAT_ZERO_BITS) {
                buff.put((byte) TAG_FLOAT_0);
            } else if (f == MVObjectDataType.FLOAT_ONE_BITS) {
    ...
    static class DoubleType extends AutoDetectDataType {
        ...
        DoubleType(MVObjectDataType base) {
        ...
        public void write(MVWriteBuffer buff, Object obj) {
            ...
            if (d == MVObjectDataType.DOUBLE_ZERO_BITS) {
                buff.put((byte) TAG_DOUBLE_0);
            } else if (d == MVObjectDataType.DOUBLE_ONE_BITS) {
    ...
    static class BigIntegerType extends AutoDetectDataType {
        ...
        BigIntegerType(MVObjectDataType base) {
    ...
    static class BigDecimalType extends AutoDetectDataType {
        ...
        BigDecimalType(MVObjectDataType base) {
    ...
    static class StringType extends AutoDetectDataType {
        ...
        StringType(MVObjectDataType base) {
    ...
    static class UUIDType extends AutoDetectDataType {
        ...
        UUIDType(MVObjectDataType base) {
    ...
    static class DateType extends AutoDetectDataType {
        ...
        DateType(MVObjectDataType base) {
    ...
    static class ObjectArrayType extends AutoDetectDataType {
        ...
        private final MVObjectDataType elementType = new MVObjectDataType();

        ObjectArrayType(MVObjectDataType base) {
        ...
        public void write(MVWriteBuffer buff, Object obj) {
            ...
            if (classId != null) {
                ...
                MVStringDataType.INSTANCE.write(buff, c);
            }
        ...
        public Object read(ByteBuffer buff, int tag) {
            ...
            Object obj;
            if (ct == -1) {
                String componentType = MVStringDataType.INSTANCE.read(buff);
                try {
    ...
    static class SerializedObjectType extends AutoDetectDataType {
        ...
        SerializedObjectType(MVObjectDataType base) {
        ...
        public int compare(Object aObj, Object bObj) {
            ...
            MVDataType ta = getType(aObj);
            MVDataType tb = getType(bObj);
            if (ta != this || tb != this) {
                if (ta == tb) {
