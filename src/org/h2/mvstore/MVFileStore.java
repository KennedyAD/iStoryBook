...
import org.h2.mvstore.cache.MVFilePathCache;
...
public class MVFileStore {
     ...
     */
    protected final MVFreeSpaceBitSet freeSpace =
            new MVFreeSpaceBitSet(2, MVStore.BLOCK_SIZE);
    ...
    public void open(String fileName, boolean readOnly, char[] encryptionKey) {
        ...
        try {
            ...
            file = MVFilePathCache.wrap(file);
            try {
                if (readOnly) {
