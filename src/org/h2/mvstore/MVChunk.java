...
public class MVChunk {
     ...
     * @return the chunk
     */
    static MVChunk readChunkHeader(ByteBuffer buff, long start) {
     ...
     */
    void writeChunkHeader(MVWriteBuffer buff, int minLength) {
    ...
    public boolean equals(Object o) {
        return o instanceof MVChunk && ((MVChunk) o).id == id;
    }
    ...
    byte[] getFooterBytes() {
        ...
        while (buff.length() < MVChunk.FOOTER_LENGTH - 1) {
            buff.append(' ');
        }
        buff.append("\n");
