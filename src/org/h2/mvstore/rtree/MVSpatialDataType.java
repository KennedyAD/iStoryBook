 ...
 */
public class MVSpatialDataType implements MVDataType {

    private final int dimensions;

    public MVSpatialDataType(int dimensions) {
    ...
    public int compare(Object a, Object b) {
        ...
        long la = ((MVSpatialKey) a).getId();
        long lb = ((MVSpatialKey) b).getId();
    ...
    public void write(MVWriteBuffer buff, Object obj) {
        MVSpatialKey k = (MVSpatialKey) obj;
        if (k.isNull()) {
            buff.putVarInt(-1);
    ...
    public Object read(ByteBuffer buff) {
        ...
        long id = DataUtils.readVarLong(buff);
        return new MVSpatialKey(id, minMax);
    }
    ...
    public boolean isOverlap(Object objA, Object objB) {
        MVSpatialKey a = (MVSpatialKey) objA;
        MVSpatialKey b = (MVSpatialKey) objB;
    ...
    public void increaseBounds(Object bounds, Object add) {
        MVSpatialKey a = (MVSpatialKey) add;
        MVSpatialKey b = (MVSpatialKey) bounds;
        if (a.isNull() || b.isNull()) {
            return;
        }
        for (int i = 0; i < dimensions; i++) {
    ...
    private float getArea(MVSpatialKey a) {
        if (a.isNull()) {
            return 0;
        }
        float area = 1;
    ...
    Object createBoundingBox(Object objA) {
        ...
        return new MVSpatialKey(0, minMax);
    }
    ...
    public int[] getExtremes(ArrayList<Object> list) {
        ...
        MVSpatialKey bounds = (MVSpatialKey) createBoundingBox(list.get(0));
        MVSpatialKey boundsInner = (MVSpatialKey) createBoundingBox(bounds);
        for (int i = 0; i < dimensions; i++) {
        ...
        for (int i = 0; i < list.size() &&
            ...
            MVSpatialKey o = (MVSpatialKey) list.get(i);
