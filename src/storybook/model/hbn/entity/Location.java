...
public class Location extends AbstractEntity implements Comparable<Location> {
	 ...
	 * @param site the site
	 */
	public Location(String name, String address, String city, String country, Integer altitude, String description,
			String notes, Location site) {
		this.name = name;
	...
	/**
	 * Gets the full parent name.
	 *
	 * @return the full parent name
	 */
	...
	public void setSite(Location site) {
		...
		try {
			// Compatibility with earlier oStorybook versions (9.4.17 or
			// earlier)
			if (site.hasCity()) {
