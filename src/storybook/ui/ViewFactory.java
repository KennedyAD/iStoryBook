...
public class ViewFactory {
	...
	public void unloadView(SbView view) {
		...
		if (ViewName.SCENES.compare(view) || ViewName.CHAPTERS.compare(view) || ViewName.PARTS.compare(view)
				...
				|| ViewName.CATEGORIES.compare(view) || ViewName.STRANDS.compare(view) || ViewName.IDEAS.compare(view)
				|| ViewName.MEMOS.compare(view) || ViewName.TAGS.compare(view) || ViewName.ITEMS.compare(view)
				|| ViewName.TAGLINKS.compare(view) || ViewName.ITEMLINKS.compare(view)
