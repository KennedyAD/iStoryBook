...
public class BookPropertiesDialog extends AbstractDialog {
	...
	private JPanel createInfoTab() {
		...
		buf.append(HtmlUtil.getRow2Cols(I18N.getMsgColon("msg.common.chapters"),
		...
		buf.append(
				HtmlUtil.getRow2Cols(I18N.getMsgColon("msg.common.persons"), Integer.toString(personDao.count(null))));
	...
	private JPanel createOdfTab() {
		...
		if (BookUtil.isUseSimpleTemplate(mainFrame))
			...
			cbUseDefaultTemplate.setSelected(true);
	...
	protected AbstractAction getOkAction() {
		return new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				BookUtil.store(mainFrame, BookKey.EXPORT_CHAPTER_DATES_LOCATIONS,
