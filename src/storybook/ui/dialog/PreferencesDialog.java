...
public class PreferencesDialog extends AbstractDialog implements ActionListener, CaretListener {
	...
	private JPanel createAppearancePanel() {
		 ...
		 * UIManager.getInstalledLookAndFeels(); Map map = new TreeMap(); for
		 * (UIManager.LookAndFeelInfo info1 : info) { String nomLF =
		 * info1.getName(); String nomClasse = info1.getClassName();
		 * //map.put(nomLF,nomClasse); lafModel.addElement(nomLF); }
		 */
